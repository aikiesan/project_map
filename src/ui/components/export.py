...
using the CP2B Maps V2 platform, a professional biogas analysis system.
...
This analysis was generated using CP2B Maps V2, a professional platform for
...
"""
    ...
    def _create_detailed_report_content(self, data: pd.DataFrame,
        ...
        report = f"""# CP2B Maps V2 - Detailed Analysis Report

**Generated:** {timestamp}
**Platform:** CP2B Maps V2 - Professional Biogas Analysis System
...
**Report Generated by CP2B Maps V2**
